...
export default function Select({ filter, setFilter }) {
   ...
   return (
      <div
         ...
         className={opened ? 'heading__select select select_open' : 'heading__select select'}
         ref={ref}
      >
         <button className="select__active">{filter}</button>
         <div className="select__items">
            <SelectItem setFilter={setFilter} value='all' >All</SelectItem>
            <SelectItem setFilter={setFilter} value='complete'>Complete</SelectItem>
            <SelectItem setFilter={setFilter} value='incomplete'>Incomplete</SelectItem>
         </div>
      </div>
   )
}